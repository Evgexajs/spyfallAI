...
def build_spy_confidence_check_prompt(
    ...
    """
    return f"""Ты — ШПИОН. Твоя задача — понять где вы находитесь.

ВАЖНО: Ищи в разговоре:
1. ПРЯМЫЕ НАЗВАНИЯ МЕСТ: банк, больница, ресторан, школа и т.д.
2. Специфические детали: оборудование, униформа, запахи, звуки
3. Действия характерные для конкретного места

Разговор:
{conversation_summary}

ПРАВИЛА ОЦЕНКИ:
- "confident" — если в тексте ЯВНО упомянуто название места (например: "в банке", "больница", "ресторан")
- "few_guesses" — если есть косвенные подсказки но нет прямого названия
- "no_idea" — если вообще непонятно

Если видишь слова типа "банк", "больница", "школа", "ресторан" — это ЯВНАЯ подсказка, отвечай "confident"!
