...
### TASK-048: Точки интеграции для звукового слоя (заглушки)
**Date:** 2026-04-22
**Status:** done
**Summary:** Добавлены 4 точки интеграции для будущего звукового слоя согласно PRD 7.3. Созданы stub-функции и SOUND_HOOK комментарии в main.ts: onCharacterStartedSpeaking() — для TTS персонажей, onPhaseChange() — для звуковых акцентов смены фаз, onSpyGuess() — для драматического момента угадывания, onLocationLoaded() — для фоновой атмосферы локации.
**Files changed:**
