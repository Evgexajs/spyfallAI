...
while has_pending_tasks; do
    ...
    prompt=$(cat <<EOF
@${TASKS_FILE} @progress.md @CLAUDE.md @docs/PRD-SpyfallAI-2026-04-19.md
...
- **code-architect** — проектирование структуры новых модулей, рефакторинг архитектуры.
  Используй для задач категории "infrastructure", "functional" с новыми модулями.

- **solution-architect** — выбор технологий, оценка вариантов реализации.
